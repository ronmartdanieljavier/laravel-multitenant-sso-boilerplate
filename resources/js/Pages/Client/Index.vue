...
const apps = [
    ...
    { name: 'Client Hub', description: 'Access client records and manage your account.', icon: '🏢', color: 'emerald', href: '#' },
        ...
        <header class="border-b border-white/5 bg-slate-900/70 backdrop-blur sticky top-0 z-10">
            <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-semibold text-white">Client Portal</span>
                </div>
