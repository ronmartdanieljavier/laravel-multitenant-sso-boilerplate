                ...
                <form @submit.prevent="submit" class="space-y-4">
                    <div>
                        ...
                        <input v-model="form.name" type="text" autofocus
                               class="w-full bg-slate-800 border border-white/10 rounded-lg px-3 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-violet-500"
                    ...
                    <button type="submit"
                            ...
                            class="w-full bg-violet-600 hover:bg-violet-500 disabled:opacity-50 text-white text-sm font-medium py-2.5 rounded-lg transition mt-2">
